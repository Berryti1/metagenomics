...
tar -czvf 202_deinterleaved.tar.gz *.fq
cp 202_deinterleaved.tar.gz /mnt/gluster/tdberry

#tar up the displayed output (which isn't useful really) and copy to gluster
tar -czvf 202.output.tar.gz 202.out
cp 202.output.tar.gz /mnt/gluster/tdberry
